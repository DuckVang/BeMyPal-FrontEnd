...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 overflow-hidden bg-base-200 text-base ">
      <nav className="flex flex-row items-center justify-between py-4 px-2 font-medium ">
